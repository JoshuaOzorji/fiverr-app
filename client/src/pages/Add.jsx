...
const Add = () => {
	...
	return (
		<main className='padding py-2'>
			{/* BREADCRUMB */}
			<span className=''>
				<BreadCrumb breadcrumbs={[{ title: "Add New Gig", link: "/add" }]} />
			</span>

			<section className='my-6 font-lato text-accent flex flex-col justify-center'>
					...
					<div className='flex flex-col'>
						...
						<span>
							<button
								...
								className='button px-2 py-1 animate'>
					...
					<div className='inputs'>
						...
						<form
							...
							<button type='submit' className=''>
								<p className='text-sm md:text-base button py-1 px-2 ml-4'>
									Add
								</p>
							</button>
						</form>
